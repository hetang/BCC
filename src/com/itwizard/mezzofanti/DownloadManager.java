...
public class DownloadManager implements Runnable
{
	...
	public class ServerLang
	{
		...
		public String sFullName;	//English
		public String sExtName;	//eng
		public long lDownloadSz;	//26MB - ignored at this point (because we can get this via the protocol)
	...
	public ServerLang [] m_ServerLanguages = new ServerLang[0];	// vector holding the languages available on the server
	...
	public boolean DownloadLanguageBrief(String url, String filename)
	{
		...
		try {
		    ...
		    File fDir = new File(Mezzofanti.TEMP_PATH);
		    fDir.mkdirs();
	...
	public int GetDownloadStatus()
	{
		...
		//Log.v(TAG, "GetDownloadStatus(): downloaded "+m_lCurrentDownloadSz +"B ["+proc_down+"%]");
